...
ㅤ更新了配置文件，版本号到`3.32.1`，新增 "环球挑战赛" 互助码类环境变量，新增 "定义宠汪汪赛跑是否开启本地账号内部互助" 环境功能控制变量。您可根据对应版本《使用与更新》教程之<更新教程>的第2命令手动更新替换配置文件，您也可以通过控制面板对比工具自行修改。

- __2021/3/08 16:00 `更新`__
ㅤ更新了配置文件，版本号到`3.32.0`，新增 "定义京小兑是否将抽奖卷自动兑换为兑币" 环境功能控制变量，修正了部分注释内容。您可根据对应版本《使用与更新》教程之<更新教程>的第2命令手动更新配置文件，您也可以通过控制面板对比工具自行修改。
