...
- __2021/3/10 03:00 `更新`__
ㅤ更新了控制面板，优化各个模块的文字排版。请所有朋友执行 `git_pull` 一键更新脚本，然后根据对应版本《使用与更新》教程之<控制面板教程>的第3条命令重启控制面板完成更新。
...
> _注意：此镜像大约需要占用 `239MB` 的空闲存储空间，目前最新版本的镜像ID为 `52c690aa52a9` 。_
#### __启动容器：__
    docker run -dit \
