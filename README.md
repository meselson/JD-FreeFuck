...
- __2021/3/10 19:30 `更新`__
ㅤ修复了控制面板无法访问的问题，原因是下午同步了上游源码，目前已紧急回退更新，如果您下午没有执行更新脚本则忽略此通知。请所有朋友执行 git_pull 一键更新脚本，然后根据对应版本《使用与更新》教程之<控制面板教程>的第3条命令重启控制面板完成修复。本项目前致力于开发控制面板，难免会出现问题，多多理解，遇到问题请立即反馈，感谢您的理解与支持
