...
> 具体更新命令请前往 [Wiki](https://github.com/SuperManito/JD-FreeFuck/wiki/ 查看通知

- __2021/2/25 15:00 `通知`__
ㅤ本项目开始进行大更新，将以全新的面貌到来，如果在此期间遇到无法使用的问题请立即反馈......

- __2021/2/24 14:30 `更新`__
ㅤ更新了 `manual-update.sh` 一键更新脚本，增加了新的功能。

- __2021/2/25 10：00 修复__
ㅤ修复了一键生成互助码脚本的错误。

- __2021/2/25 1:00 `通知`__
ㅤ更换了执行 `manual-update.sh` 一键更新脚本的命令，注意今后使用新命令。

- __2021/2/24 18:20 `修复`__
ㅤ彻底修复了关于Docker版本 `定时任务` 配置不正确的问题

- __2021/2/24 17:50 `修复`__
ㅤ修复了关于部署 `diy` 脚本后执行 `run-all.sh` 脚本后遇到报错并卡住问题

- __2021/2/24 14:00 `通知`__
ㅤGitee的库的脚本被官方屏蔽，为了保证项目的长久运行，即日起下架Gitee命令，换用Github命令部署此项目。


- __2021/2/21 `重要通知`__\
由于活动脚本作者lxk0301的库触发Gitee监控机制被官方封禁，解封后库从公开状态变为私有状态，目前已修复完毕，请所有已部署的朋友根据《使用与更新》中`卸载此项目`的第一条命令删除整个项目文件夹后重新部署，遇到问题还请立即反馈。
...
__ㅤㅤ`Telegram` 通知频道：[ https://t.me/jd_freefuck ](https://t.me/jd_freefuck)__\
...
#### 6. 为了保持本项目的长久与稳定运作，请不要滥用 `平台资源` ，不要 `传播与使用` 被第三者修改过的本项目中的脚本。
#### 7. 由衷感谢各位大佬对此项目作出的贡献，感谢各位用户朋友向我纠正出本项目中存在的错误内容以及所有反馈！
ㅤ

***

__请ㅤㅤ认ㅤㅤ真ㅤㅤ阅ㅤㅤ读ㅤㅤ教ㅤㅤ程ㅤ，ㅤ90%ㅤㅤ的ㅤㅤ问ㅤㅤ题ㅤㅤ都ㅤㅤ能ㅤㅤ找ㅤㅤ到ㅤㅤ答ㅤㅤ案ㅤㅤ！__
...
> 如果您的系统或版本未在此列表中，请使用 `Docker` 版本部署此项目
