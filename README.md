...
由于活动脚本作者lxk0301大佬的库触发Gitee监控机制被官方封禁，解封后库从公开状态变为私有状态，目前已修复完毕，已部署的朋友请执行更新命令，更新命令位于下方《使用于更新》中的倒数第二条，遇到问题还请立即反馈，制作不易、维护艰辛，各位老板可对我进行打赏，感激不尽！\
\
Docker教程还在制作中......\
如果更新完依然无法拉取活动脚本，那就重新部署......
