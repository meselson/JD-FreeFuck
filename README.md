...
__更新：__\
__2021/2/6__\
__修复了`run-all.sh`一键执行所有活动脚本关于重复添加`疯狂的JOY`挂机活动的错误，5号部署的朋友请执行更新命令，更新命令下方在第四步中的第3条......__\
\
__通知：__\
__2021/2/5__\
__由于Linux环境原作者退隐江湖，旧版本所使用的Docker镜像已下架，已部署的朋友请重新部署，新版本会自动备份之前的配置文件......__\
__新版本为系统直装，基于原作者公布的源码开发而来，制作不易，感谢支持！如果老板成功薅到羊毛，赏5毛可否(∩_∩)__
...
- __`CentOS`：支持 7.0 ~ 8.3 版本，如果是最小化安装，请通过SSH方式进入到终端__
  ...
  _附：[基于 Docker 的安装方法（软路由、NAS）](https://github.com/SuperManito/JD-FreeFuck/wiki/%E5%9F%BA%E4%BA%8E-Docker-%E7%9A%84%E5%AE%89%E8%A3%85%E6%96%B9%E6%B3%95%EF%BC%88%E8%BD%AF%E8%B7%AF%E7%94%B1%E3%80%81NAS%EF%BC%89)\
...
7. 之前填入的 Cookie 部分内容具有一定的时效性，若提示失效请根据教程重新获取并通过命令手动更新
