...
- Ubuntu本人测试环境为Ubuntu 18.04/20.04 LTS，建议优先使用Ubuntu系统
- CentOS本人测试环境为CentOS 8，暂时不适用7及更低版本，如果是最小化安装，请通过SSL方式进入到终端
## 原作者GitHub项目地址：
...
附2：如果没有科学上网方式将无法连接`RAW`服务器提示无法解决`Hosts`，可通过添加解析记录以解决连通性问题，命令如下：
