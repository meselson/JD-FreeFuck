...
function EnvStructures() {
  if [ $SYSTEM = "Debian" ]; then
    ...
    sed -i "s#deb.nodesource.com/node_14.x#mirrors.ustc.edu.cn/nodesource/deb/node_14.x#" /etc/apt/sources.list.d/nodesource.list
    deb https://deb.nodesource.com/node_14.x groovy main > /etc/apt/sources.list.d/nodesource.list
    deb-src https://deb.nodesource.com/node_14.x groovy main >> /etc/apt/sources.list.d/nodesource.list
